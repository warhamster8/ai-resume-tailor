...
export default function ResumeHTMLPreview({ data, templateId }: Props) {
  ...
  return (
    <div className="bg-white w-[210mm] min-h-[297mm] shadow-2xl mx-auto p-[15mm] text-[#333] font-sans overflow-hidden">
      {/* Header */}
      <header className="mb-8 text-center lg:text-left">
        <h1 className="text-4xl font-black tracking-tighter text-[#1a1a1a] uppercase leading-none mb-2">
          {data.personalInfo.fullName}
        </h1>
        <p className="text-sm tracking-[0.2em] text-gray-500 uppercase font-medium">
          {data.personalInfo.title || 'Technical Professional'}
        </p>
      ...
      <section className="bg-[#2d2d2d] text-white p-8 mb-10 rounded-sm">
